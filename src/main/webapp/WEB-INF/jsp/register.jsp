...
<div class="container-fluid p-5">
    <div class="container">
        <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
            <h6 class="text-primary text-uppercase">Registrarse</h6>
            <h1 class="display-5 text-uppercase mb-0">Crea una cuenta</h1>
        </div>
        <div class="row g-5">
            <div class="col-lg-7 mx-auto"> <!-- Agregada la clase mx-auto -->
                <form action="/register" method="post">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <input type="text" class="form-control bg-light border-0 px-4" placeholder="Nombre"
                                   name="userNombre" style="height: 55px;">
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="form-control bg-light border-0 px-4" placeholder="Apellido"
                                   name="userApellido" style="height: 55px;">
                        </div>
                        <div class="col-12">
                            <input type="text" class="form-control bg-light border-0 px-4" placeholder="Usuario"
                                   name="userUser" style="height: 55px;">
                        </div>
                        <div class="col-12">
                            <input type="password" class="form-control bg-light border-0 px-4" placeholder="Contraseña"
                                   name="userPassword" style="height: 55px;">
                        </div>
                        <div class="col-12">
                            <input type="password" class="form-control bg-light border-0 px-4"
                                   placeholder="Confirmar contraseña" style="height: 55px;">
                        </div>
                        <div class="col-12">
