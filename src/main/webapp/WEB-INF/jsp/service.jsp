        ...
        <div class="row g-5">
                ...
                <div class="feature-item bg-light d-flex p-4">
                    ...
                    <div>
                        <h5 class="text-uppercase mb-3"><spring:message
                                code="caracteristicasPrincipales.adopcionResponsable"/></h5>
                        <p><spring:message code="caracteristicasPrincipales.adopcionResponsableDescripcion"/></p>
                        <a href="/adopte" class="btn btn-primary"><spring:message
            ...
            <div class="col-md-6">
                <div class="feature-item bg-light d-flex p-4">
                    ...
                    <div>
                        <h5 class="text-uppercase mb-3"><spring:message
                                code="caracteristicasPrincipales.tiendaProductos"/></h5>
                        <p><spring:message code="caracteristicasPrincipales.tiendaProductosDescripcion"/></p>
                        <a href="/products" class="btn btn-primary"><spring:message
                                code="caracteristicasPrincipales.masInformacion"/></a>
                    </div>
                </div>
            </div>
