...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
            <a href="<%= request.getContextPath() %>/" class="nav-item nav-link">Inicio</a>
            <a href="/adopte" class="nav-item nav-link">Adoptar</a>
            <a href="#" class="nav-item nav-link">Servicios</a>
            <a href="/list-products" class="nav-item nav-link active">Productos</a>
            ...
            <a href="/login" class="nav-item nav-link nav-contact bg-primary text-white px-5 ms-lg-5">Iniciar sesion</a>
        </div>
    </div>
</nav>
<!-- Fin navegador -->
