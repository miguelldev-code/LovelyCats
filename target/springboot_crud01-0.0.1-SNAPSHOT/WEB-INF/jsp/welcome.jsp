    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle bi bi-translate" data-bs-toggle="dropdown"><spring:message code="navbar.idioma"/></a>
        ...
        <div class="row gx-5">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded" src="/resources/img/about.jpg" alt="<spring:message code='acercaDeNosotros.titulo' />" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="border-start border-5 border-primary ps-5 mb-5">
                    <h6 class="text-primary text-uppercase"><spring:message code="acercaDeNosotros.titulo" /></h6>
                    <h1 class="display-5 text-uppercase mb-0"><spring:message code="acercaDeNosotros.mantenerFelices" /></h1>
                </div>
                <h4 class="text-body mb-4"><spring:message code="acercaDeNosotros.subtitulo" /></h4>
                <div class="bg-light p-4">
                    <ul class="nav nav-pills justify-content-between mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item w-50" role="presentation">
                            <button class="nav-link text-uppercase w-100 active" id="pills-1-tab" data-bs-toggle="pill" data-bs-target="#pills-1" type="button" role="tab" aria-controls="pills-1" aria-selected="true"><spring:message code="acercaDeNosotros.nuestraMision" /></button>
                        </li>
                        <li class="nav-item w-50" role="presentation">
                            <button class="nav-link text-uppercase w-100" id="pills-2-tab" data-bs-toggle="pill" data-bs-target="#pills-2" type="button" role="tab" aria-controls="pills-2" aria-selected="false"><spring:message code="acercaDeNosotros.nuestraVision" /></button>
                        </li>
                    </ul>
...
<!-- Inicio Características Principales -->
<div class="container-fluid py-5">
    <div class="container">
        <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
            <h6 class="text-primary text-uppercase"><spring:message code="caracteristicasPrincipales.titulo" /></h6>
            <h1 class="display-5 text-uppercase mb-0"><spring:message code="caracteristicasPrincipales.descubre" /></h1>
        </div>
        <div class="row g-5">
            <div class="col-md-6">
                <div class="feature-item bg-light d-flex p-4">
                    <i class="bi bi-heart display-1 text-primary me-4"></i>
                    <div>
                        <h5 class="text-uppercase mb-3"><spring:message code="caracteristicasPrincipales.adopcionResponsable" /></h5>
                        <p><spring:message code="caracteristicasPrincipales.adopcionResponsableDescripcion" /></p>
                        <a href="/adopte" class="btn btn-primary"><spring:message code="caracteristicasPrincipales.masInformacion" /></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="feature-item bg-light d-flex p-4">
                    <i class="bi bi-chat-dots display-1 text-primary me-4"></i>
                    <div>
                        <h5 class="text-uppercase mb-3"><spring:message code="caracteristicasPrincipales.comunidadActiva" /></h5>
                        <p><spring:message code="caracteristicasPrincipales.comunidadActivaDescripcion" /></p>
                        <a href="#" class="btn btn-primary"><spring:message code="caracteristicasPrincipales.masInformacion" /></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="feature-item bg-light d-flex p-4">
                    <i class="bi bi-shop display-1 text-primary me-4"></i>
                    <div>
                        <h5 class="text-uppercase mb-3"><spring:message code="caracteristicasPrincipales.tiendaProductos" /></h5>
                        <p><spring:message code="caracteristicasPrincipales.tiendaProductosDescripcion" /></p>
                        <a href="/products" class="btn btn-primary"><spring:message code="caracteristicasPrincipales.masInformacion" /></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="feature-item bg-light d-flex p-4">
                    <i class="bi bi-book display-1 text-primary me-4"></i>
                    <div>
                        <h5 class="text-uppercase mb-3"><spring:message code="caracteristicasPrincipales.contenidoEducativo" /></h5>
...
<div class="container-fluid bg-dark text-secondary mt-5 py-5 px-sm-3 px-md-5">
    <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <p class="mb-2"><i class="bi bi-envelope-open text-primary me-2"></i><spring:message code="footer.correo" /></p>
            <p class="mb-0"><i class="bi bi-telephone text-primary me-2"></i><spring:message code="footer.telefono" /></p>
        </div>
        <div class="col-lg-3 col-md-6 mb-5">
            <h4 class="text-uppercase text-light mb-4"><spring:message code="footer.enlacesRapidos" /></h4>
            <div class="d-flex flex-column justify-content-start">
                <a class="text-secondary mb-2" href="<%= request.getContextPath() %>/"><spring:message code="footer.inicio" /></a>
    ...
    <div class="container border-top border-secondary pt-5">
        <p class="m-0 text-center text-secondary">&copy; <a class="text-primary" href="#"><spring:message code="footer.derechos" /></a>. <spring:message code="footer.disenadoPor" /> <a class="text-primary" href="#"><spring:message code="footer.disenador" /></a></p>
    </div>
</div>
<!-- Fin Footer -->
