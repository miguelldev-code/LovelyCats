...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
            ...
            <a href="/register" class="nav-item nav-link nav-contact bg-primary text-white px-5 ms-lg-5"><spring:message
                    code="navbar.registrarse"/></a>
        </div>
    </div>
</nav>
<!-- Fin navegador -->
            ...
            <div class="col-lg-7 mx-auto"> <!-- Agregada la clase mx-auto -->
                <form action="/login" method="post">
                    ...
                    <div class="text-center">
                        <p>¿No estas registrado? <a href="/register">Registrate aqui</a></p>
                    </div>
                </form>
            </div>
        </div>
